              ...
              {usbDevices.map((device, index) => (
                <div key={index} className="usb-device-item">
                  ...
                  <div className="device-details">
                    <p>厂商ID: 0x{device.vendor_id.toString(16).toUpperCase()}</p>
                    <p>产品ID: 0x{device.product_id.toString(16).toUpperCase()}</p>
      ...
      <div className="card">
        ...
        {photoUri && (
          <div className="photo-preview">
            <h3>照片预览</h3>
            <img src={photoUri} alt="拍照预览" style={{maxWidth: '100%', height: 'auto'}} />
          </div>
        )}
      </div>
